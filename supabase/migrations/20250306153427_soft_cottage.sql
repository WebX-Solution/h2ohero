...
CREATE POLICY "Enable insert for authenticated users only" ON blog_categories
  FOR INSERT TO authenticated WITH CHECK (true);

CREATE POLICY "Enable update for authenticated users only" ON blog_categories
  FOR UPDATE TO authenticated USING (true) WITH CHECK (true);

CREATE POLICY "Enable delete for authenticated users only" ON blog_categories
...
CREATE POLICY "Enable insert for authenticated users only" ON blog_tags
  FOR INSERT TO authenticated WITH CHECK (true);

CREATE POLICY "Enable update for authenticated users only" ON blog_tags
  FOR UPDATE TO authenticated USING (true) WITH CHECK (true);

CREATE POLICY "Enable delete for authenticated users only" ON blog_tags
  FOR DELETE TO authenticated USING (true);
...
CREATE POLICY "Enable insert for authenticated users only" ON blog_posts_tags
  FOR INSERT TO authenticated WITH CHECK (true);

CREATE POLICY "Enable delete for authenticated users only" ON blog_posts_tags
  FOR DELETE TO authenticated USING (true);
