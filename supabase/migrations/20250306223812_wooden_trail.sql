/*
  # Update Blog Schema and Add Required Tables

  1. Schema Updates
    - Add blog_categories table
    - Add blog_tags table
    - Add blog_posts table
    - Add blog_posts_tags junction table
...
VALUES (
  ...
  'Schwimmkurse',
  'Artikel über Schwimmkurse und Schwimmausbildung',
  NOW(),
  NOW()
...
VALUES (
  'a7c3de3d-1fea-4d7c-a8b0-29f63c4c3454',
  'Kinder',
  NOW(),
  NOW()
) ON CONFLICT DO NOTHING;
